    ...
    <div className="enrollment-container">
      ...
      <div className="enrollment-body">
        <div className="enrollment-mini-container">
          <div><span className="enrollment-step-number">1</span></div>
          <div>
        ...
        <div className="enrollment-mini-container">
          <span className="enrollment-step-number">2</span>
          <span>Contact Us</span>
          <span>If you have any questions or need additional information about our programs, don't hesitate to get in touch with us. Our friendly team is here to assist you. You can <a href="#">Contact Us &rarr;</a></span>
        </div>
        <div className="enrollment-mini-container">
          <span className="enrollment-step-number">3</span>
          <span>Complete the Application</span>
          <span>Ready to enroll? Fill out our online application form, which can be found  <a href="#">Here &rarr;</a>  Provide the necessary details, including your personal information, selected program, and any required documentation.</span>
        </div>
        <div className="enrollment-mini-container">
          <span className="enrollment-step-number">4</span>
        ...
        <div className="enrollment-mini-container">
          <span className="enrollment-step-number">5</span>
        ...
        <div className="enrollment-mini-container">
          <span className="enrollment-step-number">6</span>
          <span>Acceptance and Enrollment</span>
